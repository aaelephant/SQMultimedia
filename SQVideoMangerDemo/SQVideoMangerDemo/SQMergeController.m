...
#define NAME_STORYBOARD_ACTIVITY (@"SQMergeController")
#define IDENTIFIER_ACTIVITY (@"SQMergeController")


@interface SQMergeController ()

@end

@implementation SQMergeController
...
{
    UIStoryboard *storyboard = [UIStoryboard storyboardWithName:NAME_STORYBOARD_ACTIVITY bundle:nil];
    SQMergeController * vc = [storyboard instantiateViewControllerWithIdentifier:IDENTIFIER_ACTIVITY];
    return vc;
}
...
- (IBAction)LoadAudio:(id)sender{
    NSString *urlStr = [[NSBundle mainBundle]pathForResource:@"2074509_花香.mp3" ofType:nil];
 ...
 didFinishPickingMediaWithInfo: (NSDictionary *) info {
    ...
    if (CFStringCompare ((__bridge_retained CFStringRef) mediaType, kUTTypeMovie, 0)
        ...
        if(isSelectingAssetOne){
            ...
            AVAssetImageGenerator *imageGenerator = [AVAssetImageGenerator assetImageGeneratorWithAsset:firstAsset];
            imageGenerator.appliesPreferredTrackTransform = YES;
            CMTime time = CMTimeMakeWithSeconds(0, 1); // 获取当前的时间戳
                CMTime actualTime;
                NSError *error = nil;
            ...
            AVAssetImageGenerator *imageGenerator = [AVAssetImageGenerator assetImageGeneratorWithAsset:secondAsset];
            imageGenerator.appliesPreferredTrackTransform = YES;
            CMTime time = CMTimeMakeWithSeconds(0, 1); // 获取当前的时间戳
            CMTime actualTime;
            NSError *error = nil;
