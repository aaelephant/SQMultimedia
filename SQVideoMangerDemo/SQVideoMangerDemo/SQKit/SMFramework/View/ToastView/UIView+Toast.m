...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
  ...
  CGFloat wrapperWidth = 250;
  CGFloat wrapperHeight = 120;
  ...
  wrapperView.frame = CGRectMake(0.0, 0.0, wrapperWidth, wrapperHeight);
    ...
    if (message != nil) {
        ...
        CGSize maxSizeMessage = CGSizeMake((wrapperWidth * CSToastMaxWidth), wrapperHeight * CSToastMaxHeight);
...
- (UIView *)originalviewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
  // sanity
  if((message == nil) && (title == nil) && (image == nil)) return nil;
